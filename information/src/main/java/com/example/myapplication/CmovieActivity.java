...
public class CmovieActivity extends Activity implements AdapterView.OnItemClickListener {
    ListView listView1;
    private final String TAG="MovieActivity";
    private MovieInfo movieInfo;

    private  String url="https://api.douban.com/v2/movie/coming_soon?apikey=0b2bdeda43b5688921839c8ecb20399b&count=100";
    ...
    private Handler handler=new Handler(){
        public void handleMessage(Message msg){
            ...
            movieAdapter=new MovieAdapter(CmovieActivity.this,movieInfo.getMovie());
