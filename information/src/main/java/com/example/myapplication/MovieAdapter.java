...
public class MovieAdapter extends BaseAdapter {
    ...
    public MovieAdapter(Context context, List<Map<String,Object>>data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String mainland_pubdate=(String)item.get("mainland_pubdate");
        ...
        textView1.setText("评分："+averager.toString());
        textView2.setText("上映日期:"+mainland_pubdate);
